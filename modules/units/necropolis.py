...
class Hdrgn(Units):
    ...
    def __init__(self, i, j, count, team):
        ...
        self.mouse_over = ["31", "32", "33", "34", "35", "34", "33", "32", "31"]
...
class Blord(Units):
    ...
    def __init__(self, i, j, count, team):
        ...
        self.standing = ["62", "33", "34", "35", "36", "35", "34", "33"]
...
class Bknig(Units):
    ...
    def __init__(self, i, j, count, team):
        ...
        self.moving = ["39", "40", "41", "42", "43", "44", "45", "46"]
        self.mouse_over = ["29", "30", "31", "32", "32", "32", "32", "32", "31", "30", "29"]
        self.standing = ["58", "33", "34", "35", "36", "35", "34", "33"]
        self.getting_hit = ["49", "50", "51", "52", "53", "54"]
        self.defend = ["25", "26", "27", "28", "28", "28", "28", "28", "27", "26", "25"]
        self.death = ["49", "50", "19", "20", "21", "22", "23", "24"]
        self.dead = "24"
